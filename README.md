...
使用的API为金沙江API：[https://api.jsjapp.com/](https://api.jsjapp.com/)
...
**最近代码更新:0.17-2018-01-17-01 14:28**

**最近版本更新:v0.17-2018-01-17-01**
...
增加微信/QQ支付审核提示，可跳转至金沙江申请审核。

增加金沙江回调结果支持，在金沙江面板可显示回调结果（当前仅微信/QQ接口支持）。
